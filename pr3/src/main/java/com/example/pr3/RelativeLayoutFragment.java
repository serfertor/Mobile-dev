...
public class RelativeLayoutFragment extends Fragment  {
    ...
    private final static String TAG = "RelativeLayoutFragment";
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        ActivityRelative activity = (ActivityRelative) getActivity();
        String message = activity.getEnters();
        if (!message.isEmpty()) {
            TextView text = (TextView) view.findViewById(R.id.text_under_cookie);
